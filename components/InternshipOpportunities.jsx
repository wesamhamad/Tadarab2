...
//                         <p className="text-3xl font-bold mb-0 text-gray-900">تستطيع إضافة فرصة تدريب</p>
//                     </div>
//                     <div className="mt-4 flex justify-center">
//                         <Link href="/addInternshipPage">
//                             <a>
...
//                                     <span className="relative text-black group-hover:text-white ">إضافة</span>
//                                 </button>
//                             </a>
//                         </Link>
//                     </div>
//                     <div className="flex items-start">
//                         <p className="text-3xl font-bold mb-0 text-gray-900"> يمكنك مشاهدة التعليقات</p>
//                     </div>
//                     <div className="mt-4 flex justify-center">
//                         <Link href="/Comments">
//                             <a>
