...
//         return (
//             <div className="text-center">
//                 <h2 className="text-2xl font-bold mb-4 text-gray-800">شكرًا لإضافة فرصة تدريب!</h2>
//                 <p className="text-gray-500">لقد تم إرسالها بنجاح، ستعرض بعد الموافقة عليها.</p>
//             </div>
//         );
//     };
